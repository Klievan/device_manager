import 'flutter_mcu_manager_platform_interface.dart';
...
class FlutterMcuManager {
  Future<String?> getPlatformVersion() {
    return FlutterMcuManagerPlatform.instance.getPlatformVersion();
  }
  ...
  Future<String?> startDFU(
    ...
    return FlutterMcuManagerPlatform.instance.startDFU(
        address: address,
        filePath: filePath,
